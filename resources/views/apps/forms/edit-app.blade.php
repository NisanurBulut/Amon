<form id="editAppForm" class="ui form" autocomplete="off" method="POST" action="{{ route('apps.updateApp',$app->id) }}">
    {{ csrf_field() }}
    ...
    <div class="field">
        ...
        <div class="ui fluid field">
            <div class="ui right labeled input">
                <input value={{ $app->name }} onChange="changeInput(this)"
                type="text" name="name" placeholder="Uygulama Adı" required
    ...
    <div class="field">
        ...
        <div class="ui fluid field">
            <div class="ui right labeled input">
            <input value={{ $app->description }} style="height: 50px;" maxlength="500" rows="4" type="text" name="description"
    ...
    <div class="field">
        ...
        <div class="two fields">
            <div class="field">
                <div class="ui right labeled input">
                    <input value={{ $app->db_name }} type="text" name="db_name" placeholder="Veritabanı Adı" required
            ...
            <div class="field">
                <div class="ui right labeled input">
                    <input value={{ $app->url_address }} type="text" name="url_address" placeholder="Bağlantı Adresi" required
    ...
    <div class="field">
        ...
        <div class="two fields">
            <div class="twelve wide field">
                <div class="ui right labeled input">
                    <input value={{ $app->url_icon }} id="url_icon" type="text" name="url_icon" placeholder="Uygulama ikon adresi"
